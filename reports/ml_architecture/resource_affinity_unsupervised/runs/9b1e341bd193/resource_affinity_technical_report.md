...
Dataset summary:
- extraction timestamp: 2026-08-01T12:44:11.933917+00:00
- source rows inspected: 563
- included resources: 562
- curricular anchors: 348
- candidate resources: 214
- excluded resources: 1
- exclusions by reason: {'archived_status': 1}
- resource types: {'program_topic': 348, 'worksheet': 101, 'video': 52, 'exam': 36, 'lesson_plan': 18, 'program': 7}
- resource roles: {'curricular_anchor': 348, 'candidate_resource': 214}
- subjects represented: 2
- completeness: {'resource_id': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'title': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'resource_role': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'subject': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'language': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'level': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'learner_stage': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}, 'topic': {'known_count': 555, 'missing_count': 7, 'known_pct': 0.9875}, 'lesson_plan_extracted_topics': {'known_count': 18, 'missing_count': 544, 'known_pct': 0.032}, 'content_excerpt': {'known_count': 0, 'missing_count': 562, 'known_pct': 0.0}, 'subtype': {'known_count': 503, 'missing_count': 59, 'known_pct': 0.895}, 'profile_text': {'known_count': 562, 'missing_count': 0, 'known_pct': 1.0}}

Model comparison:
- best candidate: KMeans k=24 {"n_clusters": 24}
- Silhouette Score: 0.21879023520509436
- Calinski-Harabasz: 21.52311955796405
- Davies-Bouldin: 2.1025252599668263
- cluster count: 24
- cluster size <= 3 rate: 0.0
- cross-subject contamination: 0.2083 (5/24)
- cross-language contamination: 0.2083 (5/24)
...
- Anchor-resource alignment summary: {'top_k': 8, 'directed_edge_count': 2784, 'unique_undirected_pair_count': 2784, 'reciprocal_edge_count': 0, 'reciprocal_edge_rate': 0.0, 'mean_similarity': 0.429915, 'median_similarity': 0.414728, 'min_similarity': 0.148407, 'max_similarity': 0.921903, 'same_subject_rate': 0.9759, 'same_language_rate_known': 0.9759, 'same_level_rate_known': 0.3833, 'noise_source_edges': 0, 'noise_target_edges': 0, 'thresholds': {'0.6': 282, '0.7': 99, '0.72': 72, '0.8': 24, '0.9': 3}}
...
- winner selection score: 0.083395
- metric leader selection score: -0.001941
