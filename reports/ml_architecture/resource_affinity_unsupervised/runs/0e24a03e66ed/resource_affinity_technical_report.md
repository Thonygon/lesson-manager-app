...
Dataset summary:
- extraction timestamp: 2026-07-28T19:10:50.189210+00:00
- source rows inspected: 451
- included resources: 451
- curricular anchors: 348
- candidate resources: 103
- excluded resources: 0
- exclusions by reason: {}
- resource types: {'program_topic': 348, 'video': 48, 'exam': 33, 'lesson_plan': 15, 'program': 7}
- resource roles: {'curricular_anchor': 348, 'candidate_resource': 103}
- subjects represented: 2
- completeness: {'resource_id': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'title': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'resource_role': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'subject': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'language': {'known_count': 0, 'missing_count': 451, 'known_pct': 0.0}, 'level': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'learner_stage': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}, 'topic': {'known_count': 444, 'missing_count': 7, 'known_pct': 0.9845}, 'lesson_plan_extracted_topics': {'known_count': 15, 'missing_count': 436, 'known_pct': 0.0333}, 'subtype': {'known_count': 396, 'missing_count': 55, 'known_pct': 0.878}, 'profile_text': {'known_count': 451, 'missing_count': 0, 'known_pct': 1.0}}

Model comparison:
- best candidate: KMeans k=24 {"n_clusters": 24}
- Silhouette Score: 0.21983784636010584
- Calinski-Harabasz: 16.76708455155375
- Davies-Bouldin: 2.1816195086368677
- cluster count: 24
- cluster size <= 3 rate: 0.0417
- cross-subject contamination: 0.0833 (2/24)
...
- Anchor-resource alignment summary: {'top_k': 8, 'directed_edge_count': 2784, 'unique_undirected_pair_count': 2784, 'reciprocal_edge_count': 0, 'reciprocal_edge_rate': 0.0, 'mean_similarity': 0.394424, 'median_similarity': 0.377985, 'min_similarity': 0.119205, 'max_similarity': 0.912313, 'same_subject_rate': 0.9824, 'same_language_rate_known': None, 'same_level_rate_known': 0.333, 'noise_source_edges': 0, 'noise_target_edges': 0, 'thresholds': {'0.6': 198, '0.7': 65, '0.72': 52, '0.8': 15, '0.9': 2}}
...
Winner explanation:
- winner: KMeans k=24
- metric leader: KMeans k=3
- winner selection score: 0.182343
- metric leader selection score: 0.052806
