...
Dataset utilizado: 600 filas incluidas: 348 temas del learning program como anclas curriculares y 252 recursos candidatos.
...
- Selection score del ganador: 0.126276
- Resumen de alineación tema-recurso: {'top_k': 8, 'directed_edge_count': 2784, 'unique_undirected_pair_count': 2784, 'reciprocal_edge_count': 0, 'reciprocal_edge_rate': 0.0, 'mean_similarity': 0.465292, 'median_similarity': 0.450456, 'min_similarity': 0.196023, 'max_similarity': 0.931436, 'same_subject_rate': 0.9802, 'same_language_rate_known': 0.9802, 'same_level_rate_known': 0.4073, 'noise_source_edges': 0, 'noise_target_edges': 0, 'thresholds': {'0.6': 405, '0.7': 136, '0.72': 101, '0.8': 28, '0.9': 3}}

Fórmula de selección del ganador:
- selection_score = silhouette_score - 0.35 * cross_subject_contamination_rate - 0.30 * cross_language_contamination_rate - 0.20 * noise_ratio - 0.12 * cluster_size_2_rate - 0.08 * cluster_size_le_3_rate
...
- Ganador por score balanceado: KMeans k=24 con selection score 0.126276.
- Líder métrico por Silhouette: KMeans k=5 con selection score -0.231415.
...
## Conclusiones
El experimento generó un mapa de afinidad semántica para 600 filas y una muestra de revisión humana basada en anclas curriculares hacia recursos candidatos. La utilidad productiva debe valorarse revisando esas alineaciones y la coherencia de los clusters antes de activar el modelo en producción.
