    ...
    return {
        **run_row,
        ...
        "model_results": {
            ...
            "automatic_winner": _clean_text(run_row.get("overall_model_selection") or evaluation.get("winner")),
            "human_review_recommended_model_name": _clean_text(run_row.get("human_review_recommended_model_name")),
        ...
        "current_validated_reference": get_current_validated_run(experiment_id=_clean_text(run_row.get("experiment_id")), cache_bust=cache_bust),
