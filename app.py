...
# =========================
# 24) PAGE: ANALYTICS (FIXED KPI "BUBBLES" + NO PLACEHOLDERS)
# =========================
elif page == "analytics":
    ...
    def _set_qp(**kwargs):
        # Keep existing params but set/overwrite the ones we pass.
        try:
    ...
    # --- Determine current view (URL -> session) ---
    ...
    # -----------------------------
    # KPI "bubbles" look via CSS
    # NOTE: Avoid :has() (can break on some browsers/webviews)
    # -----------------------------
    st.markdown(
        """
        <style>
        ...
        /* Glows */
        div[data-testid="stRadio"] label[data-baseweb="radio"]:nth-child(1)::before,
        div[data-testid="stRadio"] label[data-baseweb="radio"]:nth-child(2)::before,
        div[data-testid="stRadio"] label[data-baseweb="radio"]:nth-child(3)::before,
        div[data-testid="stRadio"] label[data-baseweb="radio"]:nth-child(4)::before{
            content:"";
            position:absolute;
            width:140px;
            height:140px;
    ...
    for k in allowed_views:
        lab, val = opt_map[k]
        disp = f"{k}__{lab}__{val}"  # unique internal string
