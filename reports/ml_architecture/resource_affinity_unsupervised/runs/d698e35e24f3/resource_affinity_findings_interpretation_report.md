...
Dataset utilizado: 180 recursos educativos extraídos de Classio a partir de worksheets, exams, videos, lesson plans y learning programs.
...
Indicadores clave:
- Mejor modelo: DBSCAN eps=0.32 min_samples=2 {"eps": 0.32, "metric": "cosine", "min_samples": 2}
- Silhouette Score: 0.752721104597836
- Calinski-Harabasz: 13.501060896065765
- Davies-Bouldin: 0.6898200510253327
- Número de clusters: 54
- Contaminación entre asignaturas: 0.0556

## Conclusiones
El experimento generó un mapa de afinidad semántica para 180 recursos. La utilidad productiva debe valorarse revisando los vecinos semánticos y la coherencia de los clusters antes de activar el modelo en producción.
